  ...
  const testimonials = [
    {
      ...
      profilePic: "https://ui-avatars.com/api/?name=Stetson+Patten&background=4299e1&color=fff&size=80",
      badge: "2nd",
      category: null,
      rating: null,
      date: "October 20, 2023",
      testimonial: "If you're interested in a way to streamline your \"Message me to see how I can help with the __\" campaign in your pocket contact list, Abhishek is your guy.\n\nI have worked with Abhishek and his team for over 2 years now. They excel in efficiency with communication, efficiency, understanding exactly what I need, and Delivering on exactly what was asked for. I highly recommend! 10/10!",
      size: "large"
    },
    {
      name: "Erin L",
      ...
      company: null,
      profilePic: "https://ui-avatars.com/api/?name=Erin+L&background=8b5cf6&color=fff&size=80",
      badge: "3rd",
      category: "Visual Design",
      rating: 5.0,
      date: "December 4, 2024",
      testimonial: "While at Mydas, I worked with Abhishek on ongoing projects. He helped us create and fix email banners in Klaviyo (Mailchimp), various email banners and GIF/video projects. Abhishek works quickly and communicates well, offering options and solutions. His work helped us create fantastic end results. I'd definitely recommend working with him. (feedback redone)",
      size: "large"
    },
    {
      ...
      company: "Hiring Now!!",
      profilePic: "https://ui-avatars.com/api/?name=Abhishek+Maurya&background=ec4899&color=fff&size=80",
      badge: "2nd",
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-12">
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              {/* Rating */}
              {testimonial.rating && (
                <StarRating rating={testimonial.rating} date={testimonial.date} />
              )}
