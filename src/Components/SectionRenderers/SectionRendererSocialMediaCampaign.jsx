...
/**
 * SectionRenderer for "social-media-campaign" project
 * Customize this component for Social Media Campaign sections
 */
export default function SectionRendererSocialMediaCampaign({
  project,
  sectionName,
  stepIndex,
}) {
