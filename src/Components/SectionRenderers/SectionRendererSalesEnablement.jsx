...
/**
 * SectionRenderer for "sales-enablement" project
 * Customize this component for Sales Enablement Platform sections
 */
export default function SectionRendererSalesEnablement({
  project,
  sectionName,
  stepIndex,
}) {
