...
const PricingTabs = () => {
  ...
  const tabData = {
    partner: {
      title:
        '"Your <strong>embedded creative team with my leadership</strong> on subscription."',
      price: "$40",
    ...
    spoc: {
      title:
        '"Everything in Creative Partner — plus <strong>creative leadership & ownership.</strong>"',
      price: "$45",
    ...
    sos: {
      title:
        '"Your <strong>emergency creative lane</strong> — fast, fearless and predictable."',
      price: "$55",
      ...
      <div className="min-h-screen bg-[#F8F8F8] py-8 sm:py-12 lg:py-16 px-4">
        <div className="">
          ...
          <div className="lg:hidden">
            ...
            {/* Main Title */}
            <div className="text-xl font-bold text-center text-gray-900 mb-3 px-2 leading-tight">
              Three Ways to Work with Me!
            </div>

            {/* Subtitle */}
            <p className="text-center text-gray-700 text-xs leading-relaxed px-4 mb-6">
              No retainers. No vague estimates. Just a flat hourly model with
              full creative coverage. You know exactly what you're paying and
              how long things take — before we even start.
            </p>
            ...
            <h2
              key={`title-${activeTab}`}
              className={`text-sm text-center mb-6 text-[#1E8898] font-normal px-2 leading-relaxed ${slideInClass}`}
            ...
            <div className="w-full max-w-sm mx-auto mb-6 overflow-hidden">
              <div
                key={`card-${activeTab}`}
                className={`border-t-4 border-[#6BC6D4] shadow-md rounded-sm bg-white ${slideInClass}`}
              >
                <div className="p-5">
            ...
            <div
              ...
              className={`max-w-sm mx-auto mb-8 ${slideInClass}`}
            >
            ...
            <div className="text-center max-w-sm mx-auto">
              <p className="text-gray-700 mb-4 leading-relaxed text-xs">
                Get a clear, upfront estimate of how many hours your project
                will require before we begin.
              </p>
          ...
          <div className="hidden lg:block">
            ...
            {/* Main Title */}
            <h1 className="text-5xl xl:text-6xl font-bold text-center text-gray-900 mb-6">
              Three Ways to Work with Me!
            </h1>
            ...
            {/* Content */}
            <div className="rounded-lg px-8 py-10 overflow-hidden">
              {/* Title Quote */}
              <h2
                key={`desktop-title-${activeTab}`}
                className={`text-2xl text-center mb-16 text-[#1E8898] font-normal ${slideInClass}`}
                dangerouslySetInnerHTML={{ __html: currentData.title }}
              ></h2>
